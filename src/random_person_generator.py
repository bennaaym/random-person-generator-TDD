...
def random_age(min: int = 1, max: int = 100) -> int:
    """
...
def create_person() -> Dict[str, Union[str, int]]:
    """
    ...
    last_name = surname()
    email_service = first_name.lower() +\
        '.' + last_name.lower() +\
        '@' + random_email_service() + '.com'
    years = random_age()
